...
@test "runner image update" {
  ...
  assert_output -p 'basic-checks=["rat","infer"]'
  assert_output -p needs-build=true
...
@test "java test + pmd change" {
  ...
  assert_output -p 'basic-checks=["rat","author","checkstyle","findbugs","pmd","infer"]'
  assert_output -p needs-build=true
  assert_output -p needs-compile=true
  assert_output -p needs-compose-tests=false
...
@test "script change including javadoc.sh" {
  run dev-support/ci/selective_ci_checks.sh bad6cfdb6fea57b0940ea05c69aa122c6be08932
...
@test "java and docs change" {
  ...
  assert_output -p 'basic-checks=["rat","author","checkstyle","docs","findbugs","pmd","infer"]'
  assert_output -p needs-build=true
  assert_output -p needs-compile=true
  assert_output -p needs-compose-tests=true
  assert_output -p needs-integration-tests=true
...
@test "pom change" {
  ...
  assert_output -p 'basic-checks=["rat","checkstyle","findbugs","pmd","infer"]'
  assert_output -p needs-build=true
  assert_output -p needs-compile=true
  assert_output -p needs-compose-tests=true
  assert_output -p needs-integration-tests=true
...
@test "CI lib change" {
  ...
  assert_output -p 'basic-checks=["author","bats","checkstyle","docs","findbugs","infer","pmd","rat"]'
  assert_output -p needs-build=true
  assert_output -p needs-compile=true
  assert_output -p needs-compose-tests=true
  assert_output -p needs-integration-tests=true
