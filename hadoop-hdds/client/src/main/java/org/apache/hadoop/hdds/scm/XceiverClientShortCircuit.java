        ...
        try {
          ...
          if (LOG.isDebugEnabled()) {
            LOG.debug("Executed command {} {} on datanode {}, end-to-end {} ns, sent {} ns, receive {} ns, " +
                    " process {} ns, cmdType = {}, {}, {}",
                entry.getRequest().getClientId().toStringUtf8(), entry.getRequest().getCallId(), dn, endToEndCost,
                sentCost, receiveCost, processCost, type, entry.getSentTimeNs(), entry.getCreateTimeNs());
          }
          metrics.decrPendingContainerOpsMetrics(type);
