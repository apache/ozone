...
public class TestSampleQuantiles {
  ...
  static final org.apache.hadoop.metrics2.util.Quantile[] quantiles = { new org.apache.hadoop.metrics2.util.Quantile(0.50, 0.050),
      new org.apache.hadoop.metrics2.util.Quantile(0.75, 0.025), new org.apache.hadoop.metrics2.util.Quantile(0.90, 0.010),
      new org.apache.hadoop.metrics2.util.Quantile(0.95, 0.005), new org.apache.hadoop.metrics2.util.Quantile(0.99, 0.001) };

  org.apache.hadoop.metrics2.util.SampleQuantiles estimator;
   ...
   * to {@link org.apache.hadoop.metrics2.util.SampleQuantiles#clear()}.
   */
  @Test
  ...
  public void testQuantileError() throws IOException {
    ...
    for (int i = 0; i < NUM_REPEATS; i++) {
      ...
      Map<org.apache.hadoop.metrics2.util.Quantile, Long> snapshot;
      snapshot = estimator.snapshot();

      // Check
      for (org.apache.hadoop.metrics2.util.Quantile q : quantiles) {
  ...
  public void testInverseQuantiles() throws IOException {
    org.apache.hadoop.metrics2.util.SampleQuantiles inverseQuantilesEstimator =
