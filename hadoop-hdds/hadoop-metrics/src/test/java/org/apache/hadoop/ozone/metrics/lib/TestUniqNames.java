...
public class TestUniqNames {
  ...
  @Test public void testCommonCases() {
    org.apache.hadoop.metrics2.lib.UniqueNames u = new org.apache.hadoop.metrics2.lib.UniqueNames();
  ...
  @Test public void testCollisions() {
    org.apache.hadoop.metrics2.lib.UniqueNames u = new UniqueNames();
    u.uniqueName("foo");
