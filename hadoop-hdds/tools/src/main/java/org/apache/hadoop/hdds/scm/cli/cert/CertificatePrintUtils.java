...
/**
 * Utility class for printing certificates.
 */
public final class CertificatePrintUtils {
  private CertificatePrintUtils() {
  }

  private static final String OUTPUT_FORMAT = "%-17s %-30s %-30s %-110s %-110s";

  public static void printCertList(Logger log, List<String> pemEncodedCerts) {
  ...
  public static void printCert(X509Certificate cert, Logger log) {
