...
public class NodeIpOrHostnameUpdateHandler implements EventHandler<DatanodeDetails> {
    ...
    public void onMessage(DatanodeDetails datanodeDetails, EventPublisher publisher) {
        try {
            ...
            serviceManager.notifyEventTriggered(SCMService.Event.NODE_IP_OR_HOSTNAME_UPDATE_HANDLER_TRIGGERED);
            ...
            // handler.
            LOG.warn("NodeNotFound when updating the node Ip or host name to the decommissionManager",
                    e);
        }
    }
