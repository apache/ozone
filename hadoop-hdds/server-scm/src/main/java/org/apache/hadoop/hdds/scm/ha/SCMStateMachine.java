...
public class SCMStateMachine extends BaseStateMachine {
  ...
  public void notifyNotLeader(Collection<TransactionContext> pendingEntries) {
    ...
    scm.getScmContext().updateIsLeader(false);
  }
  ...
  public void notifyLeaderChanged(RaftGroupMemberId groupMemberId,
    ...
    if (groupMemberId.getPeerId().equals(newLeaderId)) {
      // TODO: revisit this code when getCurrentTerm is exposed from Division.
      LOG.info("current SCM becomes leader.");
      scm.getScmContext().updateIsLeader(true);
    } else {
