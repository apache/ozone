...
public interface PipelineManager extends Closeable, PipelineManagerMXBean {
  ...
  default Pipeline createPipeline(ReplicationConfig replicationConfig,
    ...
    return createPipeline(replicationConfig, excludedNodes, favoredNodes, StorageTier.getDefaultTier());
  }
  ...
  default Pipeline createPipeline(ReplicationConfig replicationConfig,
    ...
    return createPipeline(replicationConfig, nodes, StorageTier.getDefaultTier());
  }
