...
public final class RootCARotationMetrics {
  ...
  public static RootCARotationMetrics create() {
    org.apache.hadoop.metrics2.MetricsSystem metricsSystem = MetricsSystem.instance();
  ...
  private RootCARotationMetrics(org.apache.hadoop.metrics2.MetricsSystem ms) {
    this.ms = ms;
  }
