...
public interface ContainerManager {
  ...
  default ContainerInfo allocateContainer(ReplicationConfig replicationConfig,
    ...
    return allocateContainer(replicationConfig, owner, StorageTier.getDefaultTier());
  }
  ...
  default ContainerInfo getMatchingContainer(long size, String owner,
      Pipeline pipeline) {
    return getMatchingContainer(size, owner, pipeline, Collections.emptySet(), StorageTier.getDefaultTier());
  }

  default ContainerInfo getMatchingContainer(long size, String owner,
      Pipeline pipeline, Set<ContainerID> excludedContainerIDS) {
    return getMatchingContainer(size, owner, pipeline, excludedContainerIDS, StorageTier.getDefaultTier());
  }
