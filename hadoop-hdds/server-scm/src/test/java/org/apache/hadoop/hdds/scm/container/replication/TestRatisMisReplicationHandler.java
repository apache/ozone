...
public class TestRatisMisReplicationHandler {
  ...
  public void setup() {
    ...
    repConfig = RatisReplicationConfig.getInstance(ReplicationFactor.THREE);
    container = ReplicationTestUtil.createContainer(LifeCycleState.CLOSED,
            repConfig);
    NodeSchema[] schemas =
  ...
  private void testMisReplication(Set<ContainerReplica> availableReplicas,
      ...
      throws IOException {
    RatisMisReplicationHandler ratisMRH = new RatisMisReplicationHandler(
            mockedPlacementPolicy, conf, nodeManager);
    ...
    Map<DatanodeDetails, SCMCommand<?>> datanodeDetailsSCMCommandMap = ratisMRH
