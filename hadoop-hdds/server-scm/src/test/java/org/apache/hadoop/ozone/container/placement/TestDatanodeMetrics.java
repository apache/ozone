...
public class TestDatanodeMetrics {
  ...
  public void testSCMNodeMetric() {
    SCMNodeStat stat = new SCMNodeStat(100L, 10L, 90L, 0);
    ...
    SCMNodeStat newStat = new SCMNodeStat(100L, 10L, 90L, 0);
    ...
    SCMNodeStat stat1 = new SCMNodeStat(10000000L, 50L, 9999950L, 0);
    SCMNodeStat stat2 = new SCMNodeStat(10000000L, 51L, 9999949L, 0);
