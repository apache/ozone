...
|-------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|
| `<datanode-address-or-id>`          | One or more datanode identifiers as positional arguments. Each can be:<br>- Hostname (e.g., `DN-1`) - uses default CLIENT_RPC port (19864)<br>- Hostname with port (e.g., `DN-1:19864`)<br>- IP address (e.g., `192.168.1.10`)<br>- IP address with port (e.g., `192.168.1.10:19864`)<br>- Datanode UUID (e.g., `a3b63511-bdf8-4fa1-8ab6-d19c0e806f84`) - resolved via SCM<br>- Stdin (`-`) - reads identifiers from standard input, one per line | `DN-1`<br>`DN-1:19864`<br>`192.168.1.10`<br>`a3b63511-bdf8-4fa1-8ab6-d19c0e806f84`<br>`-` |
