...
| `hdds.datanode.disk.balancer.include.non.standard.containers`  | `false`                                                                                 | If true, balancer include non-standard states, i.e, QUASI_CLOSED. So both CLOSED and QUASI_CLOSED state containers are eligible for move. If false (default), balancer only moves CLOSED containers.                                                                                                                                                                                                                                                                                  |
