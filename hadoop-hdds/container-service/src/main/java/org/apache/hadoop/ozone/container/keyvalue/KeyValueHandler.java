...
public class KeyValueHandler extends Handler {
  ...
  public ContainerCommandResponseProto readBlock(
      ...
      DataStreamObserver<ReadBlockResponse> streamObserver, boolean testVariableChunks) {
  ...
  private long readBlockImpl(ContainerCommandRequestProto request, RandomAccessFileChannel blockFile,
      Container kvContainer, DataStreamObserver<ReadBlockResponse> streamObserver, boolean testVariableChunks)
      throws IOException {
