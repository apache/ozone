...
public class TestReplicationConfigValidator {
  ...
  public void testValidation() {
    ...
    try {
      ...
      GenericTestUtils.assertExceptionContains("Invalid data-parity replication " +
          "config for type EC and replication xor-6-4-{CHUNK_SIZE}. Supported data-parity are 3-2,6-3,10-4", ex);
    }
