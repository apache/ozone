...
public final class ScmConfigKeys {
  ...
  public static final String HDDS_DATANODE_UPGRADE_LAYOUT_INLINE = "hdds.datanode.upgrade.layout.inline";
  public static final boolean HDDS_DATANODE_UPGRADE_LAYOUT_INLINE_DEFAULT = true;
