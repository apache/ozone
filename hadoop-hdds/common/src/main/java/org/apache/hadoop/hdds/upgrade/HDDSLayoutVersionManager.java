...
public class HDDSLayoutVersionManager extends
  ...
  /**
   * Allows injecting finalization requirements for testing to override the
   * requirements generated by the current set of layout features in
   * {@link HDDSLayoutFeature}.
   */
  @VisibleForTesting
