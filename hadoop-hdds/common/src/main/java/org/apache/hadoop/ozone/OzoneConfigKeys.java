...
public final class OzoneConfigKeys {
  ...
  public static final String OZONE_METADATA_SNAPSHOT_ROCKSDB_METRICS_ENABLED =
      "ozone.metastore.rocksdb.metrics.enabled";
  public static final boolean
      OZONE_METADATA_SNAPSHOT_ROCKSDB_METRICS_ENABLED_DEFAULT = true;
