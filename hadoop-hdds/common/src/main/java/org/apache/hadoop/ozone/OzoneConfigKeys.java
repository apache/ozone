...
public final class OzoneConfigKeys {
  ...
  public static final String OZONE_FS_DEFAULT_BUCKET_LAYOUT =
      "ozone.fs.default.bucket.layout";

  public static final String OZONE_FS_DEFAULT_BUCKET_LAYOUT_DEFAULT =
      "FILE_SYSTEM_OPTIMIZED";

  public static final String OZONE_FS_DEFAULT_BUCKET_LAYOUT_LEGACY =
      "LEGACY";
