...
/**
 * Internal Java interface for the StorageContainerLocationProtocolService RPC
 * protocol.
 */
public interface StorageContainerLocationInternalInterface extends Closeable {
