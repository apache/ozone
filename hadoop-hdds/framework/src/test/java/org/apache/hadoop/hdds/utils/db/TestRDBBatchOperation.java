...
public class TestRDBBatchOperation {
  ...
  public void testBatchOperationWithDeleteRange() throws RocksDatabaseException {
    ...
    try (MockedConstruction<ManagedWriteBatch> mockedConstruction = Mockito.mockConstruction(ManagedWriteBatch.class,
      ...
      batchOperation.put(columnFamily, "key01".getBytes(), "value01".getBytes());
      batchOperation.put(columnFamily, "key02".getBytes(), "value02".getBytes());
      batchOperation.put(columnFamily, "key03".getBytes(), "value03".getBytes());
      batchOperation.put(columnFamily, "key03".getBytes(), "value04".getBytes());
      batchOperation.delete(columnFamily, "key05".getBytes());
      batchOperation.deleteRange(columnFamily, "key01".getBytes(), "key02".getBytes());
      batchOperation.deleteRange(columnFamily, "key02".getBytes(), "key03".getBytes());
      batchOperation.put(columnFamily, "key04".getBytes(), "value04".getBytes());
      batchOperation.put(columnFamily, "key06".getBytes(), "value05".getBytes());
      batchOperation.deleteRange(columnFamily, "key06".getBytes(), "key12".getBytes());
      batchOperation.deleteRange(columnFamily, "key09".getBytes(), "key10".getBytes());
