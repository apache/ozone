...
public class TestRocksDBCheckpointDiffer {
  ...
  void testGetSSTDiffListWithoutDB() {
    ...
    // Test 1: Regular case. Expands expandable SSTs in the initial diff.
    DifferSnapshotInfo snapInfo1 = new DifferSnapshotInfo(
        "/path/to/dbcp1", "ssUUID1", 3008L);
    DifferSnapshotInfo snapInfo2 = new DifferSnapshotInfo(
        "/path/to/dbcp2", "ssUUID2", 14980L);
    DifferSnapshotInfo snapInfo3 = new DifferSnapshotInfo(
        "/path/to/dbcp3", "ssUUID3", 17975L);
    HashSet<String> snapSST1 = new HashSet<>(Arrays.asList(
        "000059", "000053"));
    HashSet<String> snapSST2 = new HashSet<>(Arrays.asList(
        "000088", "000059", "000053", "000095"));
    HashSet<String> snapSST3 = new HashSet<>(Arrays.asList(
        "000088", "000105", "000059", "000053", "000095"));

    HashSet<String> resSameSSTs = new HashSet<>();
    HashSet<String> resDiffSSTs = new HashSet<>();
    differ.internalGetSSTDiffList(
        snapInfo3, snapInfo1, snapSST3, snapSST1,
        differ.getForwardCompactionDAG(),
        resSameSSTs, resDiffSSTs);
    // Check same and different files result
    Assertions.assertEquals(new HashSet<>(Arrays.asList(
        "000059", "000053")), resSameSSTs);
    Assertions.assertEquals(new HashSet<>(Arrays.asList(
    ...
    // Test 2: Crafted input: One source ('to' snapshot) SST file is never
    // compacted (newly flushed)
    DifferSnapshotInfo snapInfo4 = new DifferSnapshotInfo(
        "/path/to/dbcp4", "ssUUID4", 18000L);
    HashSet<String> snapSST4 = new HashSet<>(Arrays.asList(
        "000088", "000105", "000059", "000053", "000095", "000108"));
    differ.internalGetSSTDiffList(
        snapInfo4, snapInfo3, snapSST4, snapSST3,
        differ.getForwardCompactionDAG(),
        resSameSSTs, resDiffSSTs);
    // Check result
    Assertions.assertEquals(new HashSet<>(Arrays.asList(
        "000088", "000105", "000059", "000053", "000095")), resSameSSTs);
    Assertions.assertEquals(new HashSet<>(Arrays.asList(
        "000108")), resDiffSSTs);
    resSameSSTs.clear();
    resDiffSSTs.clear();
    ...
    // Test 3: Crafted input: Same SST files found during SST expansion
    HashSet<String> snapSST1Alt1 = new HashSet<>(Arrays.asList(
        "000059", "000053", "000066"));
    differ.internalGetSSTDiffList(
        snapInfo2, snapInfo1, snapSST2, snapSST1Alt1,
        differ.getForwardCompactionDAG(),
        resSameSSTs, resDiffSSTs);
    // Check result
    Assertions.assertEquals(new HashSet<>(Arrays.asList(
        "000066", "000059", "000053")), resSameSSTs);
    Assertions.assertEquals(new HashSet<>(Arrays.asList(
        "000080", "000087", "000073", "000095")), resDiffSSTs);
    resSameSSTs.clear();
    resDiffSSTs.clear();


    // Test 4: Crafted input: Skipping known processed SST.
    // Also these are invalid input that generates a loop.
    HashSet<String> snapSST1Alt2 = new HashSet<>(Arrays.asList(
        "000059", "000053", "000052"));
    HashSet<String> snapSST2Alt2 = new HashSet<>(Arrays.asList(
        "000088", "000059", "000053", "000095", "000099"));
    differ.internalGetSSTDiffList(
        snapInfo2, snapInfo1, snapSST2Alt2, snapSST1Alt2,
        differ.getForwardCompactionDAG(),
        resSameSSTs, resDiffSSTs);
    // Check result
    Assertions.assertEquals(new HashSet<>(), resSameSSTs);
    Assertions.assertEquals(new HashSet<>(), resDiffSSTs);


    // Test 5: Hit snapshot generation early exit condition
    HashSet<String> snapSST2Alt3 = new HashSet<>(Arrays.asList(
        "000088", "000059", "000053", "000062"));
    differ.internalGetSSTDiffList(
        snapInfo2, snapInfo1, snapSST2Alt3, snapSST1,
        differ.getForwardCompactionDAG(),
        resSameSSTs, resDiffSSTs);
    // Check result
    Assertions.assertEquals(new HashSet<>(Arrays.asList(
        "000059", "000053")), resSameSSTs);
    Assertions.assertEquals(new HashSet<>(Arrays.asList(
        "000066", "000080", "000087", "000073", "000062")), resDiffSSTs);
    resSameSSTs.clear();
    resDiffSSTs.clear();
  }
