...
In September/October 2020 -- just after the first stable release -- Hadoop community decided to move Ozone to a separated, top level Apache project. Apache Ozone is established by the board of the Apache Software Foundation during the October 2020 [board meeting](https://www.apache.org/foundation/records/minutes/2020/board_minutes_2020_10_21.txt).
