...
public class ReplicaManagerInsight extends BaseInsightPoint {
  ...
  public List<MetricGroupDisplay> getMetrics(Map<String, String> filters) {
    ...
    containerMetrics.addMetrics(new MetricDisplay("Stuck QuasiClosed Containers",
    ...
    ecMetrics.addMetrics(new MetricDisplay("EcReconstructionCmdsDeferredTotal",
            "replication_manager_metrics_ec_reconstruction_cmds_deferred_total"));
    ecMetrics.addMetrics(new MetricDisplay("EcPartialReconstructionSkippedTotal",
            "replication_manager_metrics_ec_partial_reconstruction_skipped_total"));
    ecMetrics.addMetrics(new MetricDisplay("EcPartialReconstructionCriticalTotal",
            "replication_manager_metrics_ec_partial_reconstruction_critical_total"));
    ecMetrics.addMetrics(new MetricDisplay("EcPartialReconstructionNoneOverloadedTotal",
            "replication_manager_metrics_ec_partial_reconstruction_none_overloaded_total"));
    ecMetrics.addMetrics(new MetricDisplay("EcPartialReplicationForOutOfServiceReplicasTotal",
            "replication_manager_metrics_ec_partial_replication_for_out_of_service_replicas_total"));
    ecMetrics.addMetrics(new MetricDisplay("EcPartialReplicationForMisReplicationTotal",
    ...
    replicaMetrics.addMetrics(new MetricDisplay("ReplicaCreateTimeoutTotal",
            "replication_manager_metrics_replica_create_timeout_total"));
    replicaMetrics.addMetrics(new MetricDisplay("DeletionCmdsSentTotal",
            "replication_manager_metrics_deletion_cmds_sent_total"));
    replicaMetrics.addMetrics(new MetricDisplay("ReplicasDeletedTotal",
            "replication_manager_metrics_replicas_deleted_total"));
    replicaMetrics.addMetrics(new MetricDisplay("ReplicaDeleteTimeoutTotal",
            "replication_manager_metrics_replica_delete_timeout_total"));
    replicaMetrics.addMetrics(new MetricDisplay("DeleteContainerCmdsDeferredTotal",
            "replication_manager_metrics_delete_container_cmds_deferred_total"));
    replicaMetrics.addMetrics(new MetricDisplay("ReplicateContainerCmdsDeferredTotal",
            "replication_manager_metrics_replicate_container_cmds_deferred_total"));
    replicaMetrics.addMetrics(new MetricDisplay("PendingReplicationLimitReachedTotal",
            "replication_manager_metrics_pending_replication_limit_reached_total"));
    replicaMetrics.addMetrics(new MetricDisplay("PartialReplicationTotal",
            "replication_manager_metrics_partial_replication_total"));
    replicaMetrics.addMetrics(new MetricDisplay("PartialReplicationForMisReplicationTotal",
