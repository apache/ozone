...
import { useAutoReloadState } from '@/v2/hooks/useAutoReloadState.hook';
...
const AutoReloadPanel: React.FC<IAutoReloadPanelProps> = ({
  onReload,
  lastRefreshed,
  ...
  const autoReloadToggleHandler = (checked: boolean) => {
    updateAutoReloadState(checked);
  ...
  return (
    <div className='auto-reload-panel' data-testid='autoreload-panel'>
      ...
      <Switch
        ...
        onChange={autoReloadToggleHandler}
