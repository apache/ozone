...
export const overviewLocators = {
    "datanodeCard": "overview-Datanodes",
    "pipelinesCard": "overview-Pipelines",
    "clusterCapacityCard": "overview-Cluster Capacity",
    ...
    "openKeysSummaryCard": "overview-Open Keys Summary",
    "deletePendingSummaryCard": "overview-Pending Deleted Keys Summary"
}
