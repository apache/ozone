...
/**
 * HTTP Response wrapped for a 'entityinfo' request.
 */
public class EntityInfoResponse {
  ...
  @JsonProperty("childEntityMetrics")
  private Map<String, List<DUResponse.DiskUsage>> childMetricsListMap;

  /** Path Status. */
  @JsonProperty("status")
  private ResponseStatus status;

  public EntityInfoResponse(EntityType entityType) {
    ...
    this.childMetricsListMap = new HashMap<>();
  ...
  public Map<String, List<DUResponse.DiskUsage>> getChildMetricsListMap() {
    return childMetricsListMap;
  }

  public void setChildMetricsListMap(Map<String, List<DUResponse.DiskUsage>>
                                         childMetricsListMap) {
    this.childMetricsListMap = childMetricsListMap;
  }
}
