 ...
 */
public class TestTotalDeletedContainerCount extends AbstractReconSqlDBTest {
  ...
  public void testDeletedContainerCount() throws Exception {
    ...
    // Test for CLOSED containers = Total-Containers - Open-Containers
    Assertions.assertEquals(2, clusterStateResponse1.getContainers() -
