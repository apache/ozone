...
/**
 * Utility to benchmark parallel iteration.
 */
public final class BenchmarkOmDBParallelItr {
  private static final Logger LOG = LoggerFactory.getLogger(BenchmarkOmDBParallelItr.class);

  private BenchmarkOmDBParallelItr() {
  }
  ...
  public static void main(String[] args) throws IOException, ExecutionException, InterruptedException {
    ...
    omMetadataManager.getFileTable().parallelTableOperation(null, null, func, LOG, 1);
