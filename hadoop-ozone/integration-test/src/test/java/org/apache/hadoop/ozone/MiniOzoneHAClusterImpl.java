...
public class MiniOzoneHAClusterImpl extends MiniOzoneClusterImpl {
  ...
  public MiniOzoneHAClusterImpl(
    ...
    omhaService = new OMHAService(activeOMList, inactiveOMList, omServiceId);
    scmhaService = new SCMHAService(activeSCMList, inactiveSCMList, scmServiceId);
  }
  ...
  protected MiniOzoneHAClusterImpl(
      ...
      String omServiceId,
      String scmServiceId) {
    this(conf, omList, null, scmList, null, hddsDatanodes, omServiceId, scmServiceId, null);
  }
  ...
  public boolean isOMActive(String omNodeId) {
    return omhaService.isOMActive(omNodeId);
  }
  ...
  public static class Builder extends MiniOzoneClusterImpl.Builder {
    ...
    public MiniOzoneCluster build() throws IOException {
      ...
      MiniOzoneHAClusterImpl cluster = new MiniOzoneHAClusterImpl(conf,
          activeOMs, inactiveOMs, activeSCMs, inactiveSCMs, hddsDatanodes, omServiceId, scmServiceId, reconServer);
...
//    }
  ...
  static class OMHAService extends MiniOzoneHAService<OzoneManager> {
    OMHAService(List<OzoneManager> activeList, List<OzoneManager> inactiveList, String serviceId) {
      super(activeList, inactiveList, serviceId, OzoneManager::getOMNodeId);
    }
  }
  ...
  static class SCMHAService extends MiniOzoneHAService<StorageContainerManager> {
    SCMHAService(List<StorageContainerManager> activeList, List<StorageContainerManager> inactiveList, String serviceId) {
      super(activeList, inactiveList, serviceId, StorageContainerManager::getScmId);
    }
  }
