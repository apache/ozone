...
public class TestOzoneSnapshotRestore {
    ...
    public void testRestoreSnapshot(BucketLayout bucketLayout) throws Exception{
        ...
        String sourcePath = OM_KEY_PREFIX + volume + OM_KEY_PREFIX + bucket + OM_KEY_PREFIX +
                snapshotKeyPrefix;
    ...
    @ParameterizedTest
    @MethodSource("bucketTypes")
    public void testRestoreSnapshotDifferentBucket(BucketLayout bucketLayout) throws Exception{
        String volume = "vol-" + RandomStringUtils.randomNumeric(5);
        String bucket = "buc-" + RandomStringUtils.randomNumeric(5);
