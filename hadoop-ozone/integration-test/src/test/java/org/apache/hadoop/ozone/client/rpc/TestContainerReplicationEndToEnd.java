  ...
  public void testContainerReplication() throws Exception {
    ...
    OzoneOutputStream key =
        objectStore.getVolume(volumeName).getBucket(bucketName)
            .createKey(keyName, 0, ReplicationConfig.fromTypeAndFactor(
    ...
    GenericTestUtils.waitFor(() -> newReplicaNode.getDatanodeStateMachine()
        .getContainer().getContainerSet().getContainer(containerID) != null,
        500, 100000);
