...
public class TestReconInsightsForDeletedDirectories {
   ...
   */
  @Test
  public void testGetDeletedKeyInfo()
      throws Exception {
   ...
   */
  @Test
  public void testGetDeletedKeyInfoForNestedDirectories() throws Exception {
   ...
   */
  @Test
  public void testDeleteLargeDirectory() throws Exception {
  ...
  private void assertTableRowCount(Table<String, ?> table, int count,
    ...
    GenericTestUtils.waitFor(() -> assertTableRowCount(count, table, isRecon),
