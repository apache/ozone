...
/**
 * Integration Tests for Recon's ContainerHealthTask metrics.
 */
@Timeout(300)
public class TestContainerHealthTaskMetrics {
  private ContainerHealthMetrics metrics;
  ...
  public void init() throws Exception {
    ...
    cluster.waitForPipelineTobeReady(THREE, 30000);
    GenericTestUtils.setLogLevel(SCMDatanodeHeartbeatDispatcher.LOG,
        Level.DEBUG);
    metrics = ContainerHealthMetrics.getMetrics();
  }
  ...
  @Test
  public void testContainerHealthTaskMetrics() throws Exception {
    ...
    Pipeline pipeline =
        scmPipelineManager.getPipeline(container1.getPipelineID());
      ...
      List<UnhealthyContainers> allMissingContainers =
          reconContainerManager.getContainerSchemaManager()
              .getUnhealthyContainers(
                  ...
                  0, 1000);
      return (allMissingContainers.size() == 2);
    });
    assertEquals(2, metrics.getMissingContainerCount());
  }
