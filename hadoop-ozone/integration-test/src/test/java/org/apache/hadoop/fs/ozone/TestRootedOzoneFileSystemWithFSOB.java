...
public class TestRootedOzoneFileSystemWithFSOB
    extends TestRootedOzoneFileSystem {

  private static final Logger LOG =
      LoggerFactory.getLogger(TestRootedOzoneFileSystemWithFSOB.class);
  ...
  public TestRootedOzoneFileSystemWithFSOB(boolean setDefaultFs,
