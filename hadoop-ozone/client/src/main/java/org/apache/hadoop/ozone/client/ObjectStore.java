...
public class ObjectStore {
  ...
  private class VolumeIterator implements Iterator<OzoneVolume> {
    ...
    public boolean hasNext() {
      // IMPORTANT: Without this logic, remote iteration will not work.Removing this will break the listVolume call
      // if we try to list more than 1000 (ozone.client.list.cache ) volumes.
