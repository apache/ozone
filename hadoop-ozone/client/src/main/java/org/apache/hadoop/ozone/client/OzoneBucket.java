...
public class OzoneBucket extends WithMetadata {
  ...
  public Iterator<? extends OzoneKey> listKeys(String keyPrefix,
    ...
    if(OzoneFSUtils.isFSOptimizedBucket(getMetadata())){
      return new KeyIteratorWithFSOB(keyPrefix, prevKey);
    }
   ...
   */
  private class KeyIteratorWithFSOB extends KeyIterator{
     ...
     * @param prevKey
     */
    KeyIteratorWithFSOB(String keyPrefix, String prevKey) throws IOException {
