...
public final class OmCompletedRequestInfo implements CopyObject<OmCompletedRequestInfo> {
  ...
  public abstract static class OperationArgs {
     ...
     * CreateVolumeArgs.
     */
    public static class CreateVolumeArgs extends OperationArgs {
     ...
     * DeleteVolumeArgs.
     */
    public static class DeleteVolumeArgs extends OperationArgs {

      @Override
      public String toString() {
        return "DeleteVolumeArgs{}";
      }
    }
     ...
     * CreateBucketArgs.
     */
    public static class CreateBucketArgs extends OperationArgs {

      @Override
      public String toString() {
        return "CreateBucketArgs{}";
      }
    }
     ...
     * DeleteBucketArgs.
     */
    public static class DeleteBucketArgs extends OperationArgs {

      @Override
      public String toString() {
        return "DeleteBucketArgs{}";
      }
    }
