...
package org.apache.hadoop.fs.ozone.nfs.conf;
/**
 * Configuration keys for Ozone Nfs server.
 */
public final class NfsConfigKeys {
  ...
  public static final String DFS_NFS_FILE_DUMP_DIR_DEFAULT = "/tmp/.ozone-nfs";
  ...
  public static final String DFS_NFS_MAX_READDIR_TRANSFER_SIZE_KEY = "nfs" +
      ".dtmax";
  ...
  public static final long DFS_NFS_STREAM_TIMEOUT_DEFAULT = 10 * 60 * 1000;
  // 10 minutes
  public static final long DFS_NFS_STREAM_TIMEOUT_MIN_DEFAULT = 10 * 1000; //
  // 10 seconds
  ...
  public static final String DFS_NFS_KERBEROS_PRINCIPAL_KEY = "nfs.kerberos" +
      ".principal";
  public static final String DFS_NFS_REGISTRATION_PORT_KEY = "nfs" +
      ".registration.port";
  public static final int DFS_NFS_REGISTRATION_PORT_DEFAULT = 40; //
  // Currently unassigned.
  public static final String DFS_NFS_PORT_MONITORING_DISABLED_KEY = "nfs.port" +
      ".monitoring.disabled";
  public static final boolean DFS_NFS_PORT_MONITORING_DISABLED_DEFAULT = true;

  public static final String  AIX_COMPAT_MODE_KEY = "nfs.aix.compatibility" +
      ".mode.enabled";
  ...
  public static final String NFS_HTTP_ADDRESS_DEFAULT =
      "0.0.0.0:" + NFS_HTTP_PORT_DEFAULT;
  ...
  public static final String NFS_HTTPS_ADDRESS_DEFAULT =
      "0.0.0.0:" + NFS_HTTPS_PORT_DEFAULT;
  
  public static final String  NFS_METRICS_PERCENTILES_INTERVALS_KEY = "nfs" +
      ".metrics.percentiles.intervals";
