...
@Command(
    name = "suspend",
    description = "Suspend Lifecycle Service until OM restarts, after OM restarts, " +
        "the Lifecycle Service may be enabled again based on the configuration",
...
public class LifecycleSuspendSubCommand implements Callable<Void> {
  ...
  protected void output() {
    ...
    out.println("The Lifecycle Service may be re-enabled after OM restarts");
    out.println("based on the configuration.");
    out.println("You can modify the configuration to prevent" +
