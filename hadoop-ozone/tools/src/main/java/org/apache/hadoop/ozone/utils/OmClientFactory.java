...
/**
 * Utility class to create an OM client.
 */
public final class OmClientFactory {

  private OmClientFactory() {
  }

  private static OzoneConfiguration conf = new OzoneConfiguration();

  public static OzoneManagerProtocolClientSideTranslatorPB createOmClient(
      String omServiceID, String omHost, boolean forceHA) throws Exception {
  ...
  private static String getTheOnlyConfiguredOmServiceIdOrThrow() {
  ...
  private static Collection<String> getConfiguredServiceIds() {
