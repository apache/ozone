...
execute_robot_test scm -v BUCKET:${bucket} -N s3-${bucket}-prefix-layout s3/objectputget.robot
execute_robot_test scm -v BUCKET:${bucket} -N s3-${bucket}-prefix-layout s3/objectdelete.robot
execute_robot_test scm -v BUCKET:${bucket} -N s3-${bucket}-prefix-layout s3/objectcopy.robot
execute_robot_test scm -v BUCKET:${bucket} -N s3-${bucket}-prefix-layout s3/objectmultidelete.robot
execute_robot_test scm -v BUCKET:${bucket} -N s3-${bucket}-prefix-layout s3/MultipartUpload.robot
