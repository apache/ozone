 ...
 */
public class TestS3MultipartUploadCompleteRequestWithFSOB
  ...
  protected void addKeyToTable(String volumeName, String bucketName,
    ...
    omKeyInfoFSOB.setKeyName(fileName);
    TestOMRequestUtils.addFileToKeyTable(true, false,
            fileName, omKeyInfoFSOB, clientID, omKeyInfoFSOB.getObjectID(),
            omMetadataManager);
  }
  ...
  protected S3MultipartUploadCompleteRequest getS3MultipartUploadCompleteReq(
          OMRequest omRequest) {
    return new S3MultipartUploadCompleteRequestWithFSOB(omRequest);
  }

  protected S3MultipartUploadCommitPartRequest getS3MultipartUploadCommitReq(
          OMRequest omRequest) {
    return new S3MultipartUploadCommitPartRequestWithFSOB(omRequest);
  }

  protected S3InitiateMultipartUploadRequest getS3InitiateMultipartUploadReq(
          OMRequest initiateMPURequest) {
    return new S3InitiateMultipartUploadRequestWithFSOB(initiateMPURequest);
  }
