...
public class TestOmCompletedRequestInfo {
  ...
  public void testEquals() {
    ...
    Assertions.assertTrue(requestInfo.equals(requestInfoDupe));
    Assertions.assertTrue(requestInfoDupe.equals(requestInfo));
    Assertions.assertFalse(requestInfo.equals(requestInfoWithDifference));
    Assertions.assertFalse(requestInfoWithDifference.equals(requestInfo));
  }
  ...
  public void testEqualsWithNullBucketName() {
    ...
    Assertions.assertTrue(requestInfoWithNullBucketName.equals(requestInfoWithNullBucketName));
    Assertions.assertFalse(requestInfoWithNullBucketName.equals(requestInfo));
    Assertions.assertFalse(requestInfo.equals(requestInfoWithNullBucketName));
  }
  ...
  public void testEqualsWithNullKeyName() {
    ...
    Assertions.assertTrue(requestInfoWithNullKeyName.equals(requestInfoWithNullKeyName));
    Assertions.assertFalse(requestInfoWithNullKeyName.equals(requestInfo));
    Assertions.assertFalse(requestInfo.equals(requestInfoWithNullKeyName));
  }
  ...
  public void testEqualsWithDifferentArguments() {
    ...
    Assertions.assertTrue(renameRequestInfo.equals(renameRequestInfo));
    Assertions.assertTrue(renameRequestInfoWithDifferentArgs.equals(renameRequestInfoWithDifferentArgs));
    Assertions.assertFalse(renameRequestInfo.equals(renameRequestInfoWithDifferentArgs));
    Assertions.assertFalse(renameRequestInfoWithDifferentArgs.equals(renameRequestInfo));
  }
}
