 ...
 */
public class TestS3MultipartUploadCompleteResponseWithFSOB
  ...
  public void testAddDBToBatch() throws Exception {
    ...
    addS3MultipartUploadCommitPartResponseFSOB(volumeName, bucketName, keyName,
    ...
    S3MultipartUploadCompleteResponse s3MultipartUploadCompleteResponse =
            createS3CompleteMPUResponseFSOB(volumeName, bucketName, parentID,
                    keyName, multipartUploadID, omKeyInfoFSOB,
  ...
  public void testAddDBToBatchWithParts() throws Exception {
    ...
    OmMultipartKeyInfo omMultipartKeyInfo =
            s3InitiateMultipartUploadResponseFSOB.getOmMultipartKeyInfo();

    OmKeyInfo omKeyInfoFSOB = commitS3MultipartUpload(volumeName, bucketName,
  ...
  private OmKeyInfo commitS3MultipartUpload(String volumeName,
    ...
    PartKeyInfo part1 = createPartKeyInfoFSOB(volumeName, bucketName, parentID,
        fileName, 1);
    ...
    S3MultipartUploadCommitPartResponse s3MultipartUploadCommitPartResponse =
            createS3CommitMPUResponseFSOB(volumeName, bucketName, parentID,
  ...
  private S3InitiateMultipartUploadResponse addS3InitiateMultipartUpload(
    ...
    return s3InitiateMultipartUploadResponseFSOB;
  }
  ...
  private void addS3MultipartUploadCommitPartResponseFSOB(String volumeName,
      String bucketName, String keyName, String multipartUploadID,
