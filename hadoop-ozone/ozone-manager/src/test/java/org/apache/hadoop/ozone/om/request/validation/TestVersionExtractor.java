...
class TestVersionExtractor {
  ...
  void testLayoutVersionExtractor(OMLayoutFeature layoutVersionValue) throws OMException {
    ...
    assertEquals(OMLayoutVersionValidator.class, VersionExtractor.LAYOUT_VERSION_EXTRACTOR.getValidatorClass());
  }
  ...
  void testClientVersionExtractor(ClientVersion expectedClientVersion) {
    ...
    assertEquals(OMClientVersionValidator.class, VersionExtractor.CLIENT_VERSION_EXTRACTOR.getValidatorClass());
  }
