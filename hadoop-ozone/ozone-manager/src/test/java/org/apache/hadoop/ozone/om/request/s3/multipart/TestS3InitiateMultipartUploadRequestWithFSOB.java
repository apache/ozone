 ...
 */
public class TestS3InitiateMultipartUploadRequestWithFSOB
  ...
  public void testValidateAndUpdateCache() throws Exception {
    ...
    OMRequest modifiedRequest = doPreExecuteInitiateMPUWithFSOB(volumeName,
        bucketName, keyName);

    S3InitiateMultipartUploadRequest s3InitiateMultipartUploadReqFSOB =
        getS3InitiateMultipartUploadReq(modifiedRequest);

    OMClientResponse omClientResponse =
            s3InitiateMultipartUploadReqFSOB.validateAndUpdateCache(
                    ozoneManager, 100L,
