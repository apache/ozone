 ...
 */
public class TestOMDirectoryCreateRequestWithFSOB {
  ...
  public void testPreExecute() throws Exception {
    ...
    OMRequest omRequest = createDirectoryRequest(volumeName, bucketName,
            keyName);
    OMDirectoryCreateRequestWithFSOB omDirectoryCreateRequestWithFSOB =
            new OMDirectoryCreateRequestWithFSOB(omRequest);

    OMRequest modifiedOmRequest =
            omDirectoryCreateRequestWithFSOB.preExecute(ozoneManager);
  ...
  public void testValidateAndUpdateCache() throws Exception {
    ...
    OMRequest omRequest = createDirectoryRequest(volumeName, bucketName,
            keyName);
    OMDirectoryCreateRequestWithFSOB omDirCreateRequestFSOB =
            new OMDirectoryCreateRequestWithFSOB(omRequest);

    OMRequest modifiedOmReq =
        omDirCreateRequestFSOB.preExecute(ozoneManager);

    omDirCreateRequestFSOB =
        new OMDirectoryCreateRequestWithFSOB(modifiedOmReq);

    OMClientResponse omClientResponse =
            omDirCreateRequestFSOB.validateAndUpdateCache(ozoneManager, 100L,
  ...
  public void testValidateAndUpdateCacheWithVolumeNotFound() throws Exception {
    ...
    omDirCreateRequestFSOB =
        new OMDirectoryCreateRequestWithFSOB(modifiedOmRequest);
  ...
  public void testValidateAndUpdateCacheWithBucketNotFound() throws Exception {
    ...
    OMRequest omRequest = createDirectoryRequest(volumeName, bucketName,
            keyName);
    OMDirectoryCreateRequestWithFSOB omDirCreateReqFSOB =
            new OMDirectoryCreateRequestWithFSOB(omRequest);

    OMRequest modifiedOmReq = omDirCreateReqFSOB.preExecute(ozoneManager);

    omDirCreateReqFSOB = new OMDirectoryCreateRequestWithFSOB(modifiedOmReq);
    TestOMRequestUtils.addVolumeToDB(volumeName, omMetadataManager);

    OMClientResponse omClientResponse =
            omDirCreateReqFSOB.validateAndUpdateCache(ozoneManager, 100L,
                    ozoneManagerDoubleBufferHelper);
  ...
  public void testValidateAndUpdateCacheWithFilesInPath() throws Exception {
    ...
    OMRequest modifiedOmReq =
            omDirCreateReqFSOB.preExecute(ozoneManager);
  ...
  public void testCreateDirectoryExceedLimitOfMaxLevels255() throws Exception {
    ...
    Assert.assertEquals(0L, omMetrics.getNumKeys());
    OMClientResponse omClientResponse =
            omDirCreateReqFSOB.validateAndUpdateCache(ozoneManager,
