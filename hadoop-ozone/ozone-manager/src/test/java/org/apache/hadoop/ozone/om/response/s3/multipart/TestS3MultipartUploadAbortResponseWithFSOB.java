 ...
 */
public class TestS3MultipartUploadAbortResponseWithFSOB
  ...
  protected S3MultipartUploadAbortResponse getS3MultipartUploadAbortResp(
      ...
      OzoneManagerProtocolProtos.OMResponse omResponse) {
    return new S3MultipartUploadAbortResponseWithFSOB(omResponse, multipartKey,
  ...
  public OzoneManagerProtocolProtos.PartKeyInfo createPartKeyInfo(
    ...
    return createPartKeyInfoFSOB(volumeName, bucketName, parentID, fileName,
        partNumber);
  }
}
