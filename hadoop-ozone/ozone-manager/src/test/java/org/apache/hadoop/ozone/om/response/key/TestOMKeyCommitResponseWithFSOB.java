 ...
 */
public class TestOMKeyCommitResponseWithFSOB extends TestOMKeyCommitResponse {
  ...
  protected OMKeyCommitResponse getOmKeyCommitResponse(
    ...
    return new OMKeyCommitResponseWithFSOB(omResponse, omKeyInfo, ozoneKey,
  ...
  protected void addKeyToOpenKeyTable() throws Exception {
    ...
    TestOMRequestUtils.addFileToKeyTable(true, false,
            fileName, omKeyInfoFSOB, clientID, txnLogId, omMetadataManager);
  }
