...
/**
 * Tests OMCreateKeyRequestWithFSOB class.
 */
public class TestOMKeyCreateRequestWithFSOB extends TestOMKeyCreateRequest {
  ...
  protected OMKeyCreateRequest getOMKeyCreateRequest(OMRequest omRequest) {
    return new OMKeyCreateRequestWithFSOB(omRequest);
  }
}
