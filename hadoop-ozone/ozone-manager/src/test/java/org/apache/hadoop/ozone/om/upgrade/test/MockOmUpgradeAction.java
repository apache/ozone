...
package org.apache.hadoop.ozone.om.upgrade.test;
...
/**
 * Mock class to test upgrade action registration.
 */
@UpgradeActionOm(type = UNFINALIZED_STATE_VALIDATION, feature = INITIAL_VERSION)
public class MockOmUpgradeAction implements OmUpgradeAction {

  @Override
  public void execute(OzoneManager arg) {
    String str = arg.getVersion();
  }
}
