...
class TestSnapshotCache {
  ...
  void testGet() throws IOException {
    ...
    ReferenceCounted<IOmMetadataReader, SnapshotCache, String> omSnapshot =
  ...
  void testGetTwice() throws IOException {
    final String dbKey1 = "dbKey1";
    ReferenceCounted<IOmMetadataReader, SnapshotCache, String> omSnapshot1 =
        snapshotCache.get(dbKey1);
    assertNotNull(omSnapshot1);
    assertEquals(1, snapshotCache.size());

    ReferenceCounted<IOmMetadataReader, SnapshotCache, String> omSnapshot1again =
        snapshotCache.get(dbKey1);
  ...
  void testInvalidateAll() throws IOException {
    ...
    ReferenceCounted<IOmMetadataReader, SnapshotCache, String> omSnapshot2 =
    ...
    ReferenceCounted<IOmMetadataReader, SnapshotCache, String> omSnapshot3 =
  ...
  void testEviction3WithClose() throws IOException {
    ...
    final String dbKey1 = "dbKey1";
    try (ReferenceCounted<IOmMetadataReader, SnapshotCache, String> rcOmSnapshot = snapshotCache.get(dbKey1)) {
    ...
    final String dbKey2 = "dbKey2";
    try (ReferenceCounted<IOmMetadataReader, SnapshotCache, String> rcOmSnapshot = snapshotCache.get(dbKey2)) {
      assertEquals(1L, rcOmSnapshot.getTotalRefCount());
      assertEquals(2, snapshotCache.size());
      // Get dbKey2 entry a second time
      try (ReferenceCounted<IOmMetadataReader, SnapshotCache, String> rcOmSnapshot2 = snapshotCache.get(dbKey2)) {
    ...
    final String dbKey3 = "dbKey3";
    try (ReferenceCounted<IOmMetadataReader, SnapshotCache, String> rcOmSnapshot = snapshotCache.get(dbKey3)) {
      assertEquals(1L, rcOmSnapshot.getTotalRefCount());
      assertEquals(3, snapshotCache.size());
    }
    ...
    final String dbKey4 = "dbKey4";
    try (ReferenceCounted<IOmMetadataReader, SnapshotCache, String> rcOmSnapshot = snapshotCache.get(dbKey4)) {
      assertEquals(1L, rcOmSnapshot.getTotalRefCount());
      assertEquals(1, snapshotCache.size());
    }
