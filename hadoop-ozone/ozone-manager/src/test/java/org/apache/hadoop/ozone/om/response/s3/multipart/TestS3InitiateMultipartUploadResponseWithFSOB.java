 ...
 */
public class TestS3InitiateMultipartUploadResponseWithFSOB
  ...
  public void testAddDBToBatch() throws Exception {
    ...
    S3InitiateMultipartUploadResponse s3InitiateMultipartUploadResponseFSOB =
            createS3InitiateMPUResponseFSOB(volumeName, bucketName, parentID,
                    keyName, multipartUploadID, parentDirInfos);

    s3InitiateMultipartUploadResponseFSOB.addToDBBatch(omMetadataManager,
        batchOperation);
