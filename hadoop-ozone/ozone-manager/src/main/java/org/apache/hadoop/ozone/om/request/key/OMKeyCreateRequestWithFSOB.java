...
import org.apache.hadoop.ozone.om.response.key.OMKeyCreateResponseWithFSOB;
 ...
 */
public class OMKeyCreateRequestWithFSOB extends OMKeyCreateRequest {

  public OMKeyCreateRequestWithFSOB(OMRequest omRequest) {
    super(omRequest);
  }
  ...
  public OMClientResponse validateAndUpdateCache(OzoneManager ozoneManager,
    ...
    try {
      ...
      if (pathInfoFSOB.getDirectoryResult() == DIRECTORY_EXISTS) {
      ...
      } else if (pathInfoFSOB.getDirectoryResult()
      ...
      missingParentInfos =
              OMDirectoryCreateRequestWithFSOB.getAllMissingParentDirInfo(
                      ozoneManager, keyArgs, pathInfoFSOB, trxnLogIndex);
      ...
      OmKeyInfo omFileInfo = prepareFileInfo(omMetadataManager, keyArgs,
              ...
              bucketInfo, pathInfoFSOB, trxnLogIndex,
              pathInfoFSOB.getLeafNodeObjectId(),
              ozoneManager.isRatisEnabled());

      long openVersion = omFileInfo.getLatestVersionLocations().getVersion();
      long clientID = createKeyRequest.getClientID();
      String dbOpenFileName = omMetadataManager
          .getOpenFileName(pathInfoFSOB.getLastKnownParentId(),
              pathInfoFSOB.getLeafNodeName(), clientID);
      ...
      OMFileRequest.addOpenFileTableCacheEntry(omMetadataManager,
              dbOpenFileName, omFileInfo, pathInfoFSOB.getLeafNodeName(),
              trxnLogIndex);
      ...
      omClientResponse = new OMKeyCreateResponseWithFSOB(omResponse.build(),
      ...
      omClientResponse = new OMKeyCreateResponseWithFSOB(
