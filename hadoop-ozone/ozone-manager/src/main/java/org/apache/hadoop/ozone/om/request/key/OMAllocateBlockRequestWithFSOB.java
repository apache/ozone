...
import org.apache.hadoop.ozone.om.response.key.OMAllocateBlockResponseWithFSOB;
 ...
 */
public class OMAllocateBlockRequestWithFSOB extends OMAllocateBlockRequest {

  private static final Logger LOG =
          LoggerFactory.getLogger(OMAllocateBlockRequestWithFSOB.class);

  public OMAllocateBlockRequestWithFSOB(OMRequest omRequest) {
    super(omRequest);
  }
  ...
  public OMClientResponse validateAndUpdateCache(OzoneManager ozoneManager,
    ...
    try {
      ...
      exception = ex;
      omClientResponse = new OMAllocateBlockResponseWithFSOB(
  ...
  private OMClientResponse getOmClientResponse(long clientID,
      ...
      OmBucketInfo omBucketInfo) {
    return new OMAllocateBlockResponseWithFSOB(omResponse.build(), openKeyInfo,
