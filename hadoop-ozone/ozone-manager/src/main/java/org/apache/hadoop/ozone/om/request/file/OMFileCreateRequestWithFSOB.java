...
import org.apache.hadoop.ozone.om.response.file.OMFileCreateResponseWithFSOB;
 ...
 */
public class OMFileCreateRequestWithFSOB extends OMFileCreateRequest {

  private static final Logger LOG =
      LoggerFactory.getLogger(OMFileCreateRequestWithFSOB.class);
  public OMFileCreateRequestWithFSOB(OMRequest omRequest) {
    super(omRequest);
  }
  ...
  public OMClientResponse validateAndUpdateCache(OzoneManager ozoneManager,
    ...
    try {
      ...
      checkDirectoryResult(keyName, isOverWrite,
              pathInfoFSOB.getDirectoryResult());

      if (!isRecursive) {
        checkAllParentsExist(keyArgs, pathInfoFSOB);
      }
      ...
      omClientResponse = new OMFileCreateResponseWithFSOB(omResponse.build(),
      ...
      omClientResponse = new OMFileCreateResponseWithFSOB(createErrorOMResponse(
