...
import org.apache.hadoop.ozone.om.response.key.acl.OMKeyAclResponseWithFSOB;
 ...
 */
public class OMKeyAddAclRequestWithFSOB extends OMKeyAclRequestWithFSOB {

  private static final Logger LOG =
      LoggerFactory.getLogger(OMKeyAddAclRequestWithFSOB.class);
  ...
  public OMKeyAddAclRequestWithFSOB(
  ...
  @Override OMClientResponse onSuccess(
    ...
    omResponse.setAddAclResponse(
        OzoneManagerProtocolProtos.AddAclResponse.newBuilder()
            .setResponse(operationResult));
    return new OMKeyAclResponseWithFSOB(omResponse.build(), omKeyInfo, isDir);
  }
}
