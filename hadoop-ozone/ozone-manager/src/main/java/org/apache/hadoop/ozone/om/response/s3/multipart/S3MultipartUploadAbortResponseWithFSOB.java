...
public class S3MultipartUploadAbortResponseWithFSOB
    extends S3MultipartUploadAbortResponse {

  public S3MultipartUploadAbortResponseWithFSOB(@Nonnull OMResponse omResponse,
   ...
   */
  public S3MultipartUploadAbortResponseWithFSOB(
