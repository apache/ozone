...
public final class OMAuditLogger {
  ...
  private static void init() {
    ...
    CMD_AUDIT_ACTION_MAP.put(Type.CreateManagedS3AccessKey,
        OMAction.CREATE_MANAGED_S3_ACCESS_KEY);
    CMD_AUDIT_ACTION_MAP.put(Type.ListManagedS3AccessKeys,
        OMAction.LIST_MANAGED_S3_ACCESS_KEYS);
    CMD_AUDIT_ACTION_MAP.put(Type.InfoManagedS3AccessKey,
        OMAction.INFO_MANAGED_S3_ACCESS_KEY);
    CMD_AUDIT_ACTION_MAP.put(Type.DisableManagedS3AccessKey,
        OMAction.DISABLE_MANAGED_S3_ACCESS_KEY);
    CMD_AUDIT_ACTION_MAP.put(Type.RotateManagedS3AccessKey,
        OMAction.ROTATE_MANAGED_S3_ACCESS_KEY);
    CMD_AUDIT_ACTION_MAP.put(Type.DeleteManagedS3AccessKey,
        OMAction.DELETE_MANAGED_S3_ACCESS_KEY);
    CMD_AUDIT_ACTION_MAP.put(Type.RetrieveManagedS3AccessKeySecret,
        OMAction.RETRIEVE_MANAGED_S3_ACCESS_KEY_SECRET);
