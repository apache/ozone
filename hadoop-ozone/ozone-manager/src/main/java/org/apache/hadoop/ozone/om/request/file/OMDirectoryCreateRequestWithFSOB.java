...
import org.apache.hadoop.ozone.om.response.file.OMDirectoryCreateResponseWithFSOB;
 ...
 */
public class OMDirectoryCreateRequestWithFSOB extends OMDirectoryCreateRequest {

  private static final Logger LOG =
      LoggerFactory.getLogger(OMDirectoryCreateRequestWithFSOB.class);

  public OMDirectoryCreateRequestWithFSOB(OMRequest omRequest) {
    super(omRequest);
  }
  ...
  public OMClientResponse validateAndUpdateCache(OzoneManager ozoneManager,
    ...
    try {
      ...
      OMFileRequest.OMPathInfoWithFSOB omPathInfo =
      ...
      if (omDirectoryResult == FILE_EXISTS ||
        ...
        missingParentInfos =
                OMDirectoryCreateRequestWithFSOB.getAllMissingParentDirInfo(
        ...
        omClientResponse =
            new OMDirectoryCreateResponseWithFSOB(omResponse.build(), dirInfo,
                missingParentInfos, result);
      } else {
        result = Result.DIRECTORY_ALREADY_EXISTS;
        omResponse.setStatus(Status.DIRECTORY_ALREADY_EXISTS);
        omClientResponse =
            new OMDirectoryCreateResponseWithFSOB(omResponse.build(), result);
      }
    } catch (IOException ex) {
      exception = ex;
      omClientResponse = new OMDirectoryCreateResponseWithFSOB(
  ...
  public static List<OmDirectoryInfo> getAllMissingParentDirInfo(
          ...
          OMFileRequest.OMPathInfoWithFSOB pathInfo, long trxnLogIndex)
          throws IOException {
