 ...
 */
public abstract class OMKeyAclRequestWithFSOB extends OMKeyAclRequest {

  public OMKeyAclRequestWithFSOB(OzoneManagerProtocolProtos.OMRequest omReq) {
    super(omReq);
  }
  ...
  OMClientResponse onFailure(
    ...
    return new OMKeyAclResponseWithFSOB(
