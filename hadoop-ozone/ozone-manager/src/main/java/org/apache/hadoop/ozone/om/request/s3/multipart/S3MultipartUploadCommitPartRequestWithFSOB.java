...
import org.apache.hadoop.ozone.om.response.s3.multipart.S3MultipartUploadCommitPartResponseWithFSOB;
 ...
 */
public class S3MultipartUploadCommitPartRequestWithFSOB
        extends S3MultipartUploadCommitPartRequest {

  public S3MultipartUploadCommitPartRequestWithFSOB(OMRequest omRequest) {
    super(omRequest);
  }
  ...
  public OMClientResponse validateAndUpdateCache(OzoneManager ozoneManager,
    ...
    try {
      ...
      omClientResponse = new S3MultipartUploadCommitPartResponseWithFSOB(
