...
/**
 * Response for set object metadata request for FSO bucket.
 */
@CleanupTableInfo(cleanupTables = {FILE_TABLE})
public class S3SetObjectMetadataResponseWithFSO extends S3SetObjectMetadataResponse {

  private long volumeId;
  private long bucketId;

  public S3SetObjectMetadataResponseWithFSO(@Nonnull OMResponse omResponse,
