...
import org.apache.hadoop.ozone.om.response.s3.multipart.S3InitiateMultipartUploadResponseWithFSOB;
 ...
 */
public class S3InitiateMultipartUploadRequestWithFSOB
        extends S3InitiateMultipartUploadRequest {

  public S3InitiateMultipartUploadRequestWithFSOB(OMRequest omRequest) {
    super(omRequest);
  }
  ...
  public OMClientResponse validateAndUpdateCache(OzoneManager ozoneManager,
    ...
    try {
      ...
      OMFileRequest.OMPathInfoWithFSOB pathInfoFSOB = OMFileRequest
      ...
      checkDirectoryResult(keyName, pathInfoFSOB.getDirectoryResult());

      // add all missing parents to dir table
      missingParentInfos = OMDirectoryCreateRequestWithFSOB
          .getAllMissingParentDirInfo(ozoneManager, keyArgs, pathInfoFSOB,
              transactionLogIndex);
      ...
      String multipartKey = omMetadataManager
          .getMultipartKey(pathInfoFSOB.getLastKnownParentId(),
              pathInfoFSOB.getLeafNodeName(), keyArgs.getMultipartUploadID());
      ...
      multipartKeyInfo = new OmMultipartKeyInfo.Builder()
          ...
          .setObjectID(pathInfoFSOB.getLeafNodeObjectId())
          .setUpdateID(transactionLogIndex)
          .setParentID(pathInfoFSOB.getLastKnownParentId())
          .build();
      ...
      omKeyInfo = new OmKeyInfo.Builder()
          ...
          .setObjectID(pathInfoFSOB.getLeafNodeObjectId())
          .setUpdateID(transactionLogIndex)
          .setParentObjectID(pathInfoFSOB.getLastKnownParentId())
          .build();
      ...
      OMFileRequest.addOpenFileTableCacheEntry(omMetadataManager,
              multipartKey, omKeyInfo, pathInfoFSOB.getLeafNodeName(),
              transactionLogIndex);
      ...
      omClientResponse =
          new S3InitiateMultipartUploadResponseWithFSOB(
      ...
      exception = ex;
      omClientResponse = new S3InitiateMultipartUploadResponseWithFSOB(
