 ...
 */
public class OMKeyRemoveAclRequestWithFSOB extends OMKeyAclRequestWithFSOB {

  private static final Logger LOG =
      LoggerFactory.getLogger(OMKeyRemoveAclRequestWithFSOB.class);
  ...
  public OMKeyRemoveAclRequestWithFSOB(
