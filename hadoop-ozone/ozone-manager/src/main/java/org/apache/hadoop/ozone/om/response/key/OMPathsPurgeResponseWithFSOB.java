...
/**
 * Response for {@link OMPathsPurgeRequestWithFSOB} request.
 */
@CleanupTableInfo(cleanupTables = {DELETED_TABLE, DELETED_DIR_TABLE,
    DIRECTORY_TABLE, FILE_TABLE})
public class OMPathsPurgeResponseWithFSOB extends OMClientResponse {
  private static final Logger LOG =
      LoggerFactory.getLogger(OMPathsPurgeResponseWithFSOB.class);
  ...
  public OMPathsPurgeResponseWithFSOB(@Nonnull OMResponse omResponse,
