...
public class OMDirectoryCreateResponseWithFSOB extends OMClientResponse {

  public static final Logger LOG =
      LoggerFactory.getLogger(OMDirectoryCreateResponseWithFSOB.class);

  private OmDirectoryInfo dirInfo;
  private List<OmDirectoryInfo> parentDirInfos;
  private Result result;

  public OMDirectoryCreateResponseWithFSOB(@Nonnull OMResponse omResponse,
