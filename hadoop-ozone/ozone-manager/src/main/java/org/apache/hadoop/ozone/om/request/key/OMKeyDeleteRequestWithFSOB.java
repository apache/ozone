...
import org.apache.hadoop.ozone.om.response.key.OMKeyDeleteResponseWithFSOB;
 ...
 */
public class OMKeyDeleteRequestWithFSOB extends OMKeyDeleteRequest {

  private static final Logger LOG =
      LoggerFactory.getLogger(OMKeyDeleteRequestWithFSOB.class);

  public OMKeyDeleteRequestWithFSOB(OMRequest omRequest) {
    super(omRequest);
  }
  ...
  public OMClientResponse validateAndUpdateCache(OzoneManager ozoneManager,
    ...
    try {
      ...
      omClientResponse = new OMKeyDeleteResponseWithFSOB(omResponse
      ...
      exception = ex;
      omClientResponse = new OMKeyDeleteResponseWithFSOB(
