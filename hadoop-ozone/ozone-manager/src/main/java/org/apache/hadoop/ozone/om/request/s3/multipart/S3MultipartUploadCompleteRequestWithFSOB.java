...
import org.apache.hadoop.ozone.om.response.s3.multipart.S3MultipartUploadCompleteResponseWithFSOB;
 ...
 */
public class S3MultipartUploadCompleteRequestWithFSOB
        extends S3MultipartUploadCompleteRequest {

  private static final Logger LOG =
      LoggerFactory.getLogger(S3MultipartUploadCompleteRequestWithFSOB.class);

  public S3MultipartUploadCompleteRequestWithFSOB(OMRequest omRequest) {
    super(omRequest);
  }
  ...
  public OMClientResponse validateAndUpdateCache(OzoneManager ozoneManager,
    ...
    try {
      ...
      long parentID = pathInfoFSOB.getLastKnownParentId();
      ...
      if (partsList.size() > 0) {
        ...
        omClientResponse = new S3MultipartUploadCompleteResponseWithFSOB(
