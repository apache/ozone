...
import org.apache.hadoop.ozone.om.response.key.OMKeyRenameResponseWithFSOB;
 ...
 */
public class OMKeyRenameRequestWithFSOB extends OMKeyRenameRequest {

  private static final Logger LOG =
          LoggerFactory.getLogger(OMKeyRenameRequestWithFSOB.class);

  public OMKeyRenameRequestWithFSOB(OMRequest omRequest) {
    super(omRequest);
  }
  ...
  public OMClientResponse validateAndUpdateCache(OzoneManager ozoneManager,
    ...
    try {
      ...
      exception = ex;
      omClientResponse = new OMKeyRenameResponseWithFSOB(createErrorOMResponse(
  ...
  private OMClientResponse renameKey(long toKeyParentId,
    ...
    OMClientResponse omClientResponse = new OMKeyRenameResponseWithFSOB(
