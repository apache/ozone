...
import org.apache.hadoop.ozone.om.response.key.OMKeyCommitResponseWithFSOB;
 ...
 */
public class OMKeyCommitRequestWithFSOB extends OMKeyCommitRequest {

  public OMKeyCommitRequestWithFSOB(OMRequest omRequest) {
    super(omRequest);
  }
  ...
  public OMClientResponse validateAndUpdateCache(OzoneManager ozoneManager,
    ...
    try {
      ...
      omClientResponse = new OMKeyCommitResponseWithFSOB(omResponse.build(),
      ...
      exception = ex;
      omClientResponse = new OMKeyCommitResponseWithFSOB(createErrorOMResponse(
