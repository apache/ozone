...
import org.apache.hadoop.ozone.om.response.s3.multipart.S3MultipartUploadAbortResponseWithFSOB;
 ...
 */
public class S3MultipartUploadAbortRequestWithFSOB
    extends S3MultipartUploadAbortRequest {

  public S3MultipartUploadAbortRequestWithFSOB(OMRequest omRequest) {
    super(omRequest);
  }
  ...
  protected OMClientResponse getOmClientResponse(IOException exception,
    ...
    return new S3MultipartUploadAbortResponseWithFSOB(createErrorOMResponse(
  ...
  protected OMClientResponse getOmClientResponse(OzoneManager ozoneManager,
    ...
    OMClientResponse omClientResp = new S3MultipartUploadAbortResponseWithFSOB(
