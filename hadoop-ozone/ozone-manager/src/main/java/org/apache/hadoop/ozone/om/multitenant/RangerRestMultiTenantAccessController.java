...
//
//    rangerAclStrings = MultiTenantAccessController.getRangerAclStrings();
...
//      javaPolicy.getDescription().ifPresent(desc ->
//          jsonPolicy.addProperty("description", desc));
//
//      // Add all policy labels to the json object.
//      JsonArray jsonLabelArray = new JsonArray();
//      for (String label: javaPolicy.getLabels()) {
//        jsonLabelArray.add(new JsonPrimitive(label));
//      }
//      jsonPolicy.add("policyLabels", jsonLabelArray);
//
