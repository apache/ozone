 ...
 */
public class OMKeySetAclRequestWithFSOB extends OMKeyAclRequestWithFSOB {

  private static final Logger LOG =
      LoggerFactory.getLogger(OMKeySetAclRequestWithFSOB.class);
  ...
  public OMKeySetAclRequestWithFSOB(
