...
public class OzoneBucketStub extends OzoneBucket {
    ...
    ByteBufferStreamOutput byteBufferStreamOutput =
        new ByteBufferStreamOutput() {
          ...
          private final ReplicationFactor factor =
              ReplicationFactor.valueOf(rConfig.getRequiredNodes());
          private final ReplicationType type = ReplicationType
              .valueOf(rConfig.getReplicationType().toString());
  ...
  public OmMultipartUploadCompleteInfo completeMultipartUpload(
      String key, String uploadID, Map<Integer, String> partsMap)
      throws IOException {
