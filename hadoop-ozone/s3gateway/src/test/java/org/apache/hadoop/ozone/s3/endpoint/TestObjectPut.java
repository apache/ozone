...
class TestObjectPut {
  ...
  void testPutObject(int length, ReplicationConfig replication) throws IOException, OS3Exception {
    ...
    //WHEN
    Response response = objectEndpoint.put(BUCKET_NAME, KEY_NAME, length, null, null, 1, null, null, null, body);
  ...
  void testPutObjectContentLength() throws IOException, OS3Exception {
    ...
    objectEndpoint.put(BUCKET_NAME, KEY_NAME, dataSize, null, null, 0, null, null, null, body);
  ...
  void testPutObjectContentLengthForStreaming()
    ...
    when(headers.getHeaderString(DECODED_CONTENT_LENGTH_HEADER))
        .thenReturn("15");
    objectEndpoint.put(BUCKET_NAME, KEY_NAME, chunkedContent.length(), null, null, 0, null, null,
  ...
  void testPutObjectWithSignedChunks() throws IOException, OS3Exception {
    ...
    Response response = objectEndpoint.put(BUCKET_NAME, KEY_NAME,
        chunkedContent.length(), null, null, 1, null, null, null,
    ...
    try (MockedStatic<IOUtils> mocked = mockStatic(IOUtils.class)) {
      ...
      try {
        objectEndpoint.put(BUCKET_NAME, KEY_NAME, CONTENT
            .length(), null, null, 1, null, null, null, body);
  ...
  void testCopyObject() throws IOException, OS3Exception {
    ...
    Response response = objectEndpoint.put(BUCKET_NAME, KEY_NAME,
        CONTENT.length(), null, null, 1, null, null, null, body);
    ...
    response = objectEndpoint.put(DEST_BUCKET_NAME, DEST_KEY, CONTENT.length(), null, null, 1,
        null, null, null, body);
    ...
    OS3Exception e = assertThrows(OS3Exception.class, () -> objectEndpoint.put(
            DEST_BUCKET_NAME, DEST_KEY, CONTENT.length(), null, null, 1, null, null, null, body),
    ...
    e = assertThrows(OS3Exception.class, () -> objectEndpoint.put(
            BUCKET_NAME, KEY_NAME, CONTENT.length(), null, null, 1, null, null, null, body),
        "test copy object failed");
    ...
    e = assertThrows(OS3Exception.class, () -> objectEndpoint.put(DEST_BUCKET_NAME,
        DEST_KEY, CONTENT.length(), null, null, 1, null, null, null, body), "test copy object failed");
    ...
    e = assertThrows(OS3Exception.class, () -> objectEndpoint.put(
        "nonexistent", KEY_NAME, CONTENT.length(), null, null, 1, null, null, null, body),
        "test copy object failed");
    assertThat(e.getCode()).contains("NoSuchBucket");
  }
  ...
  public void testCopyObjectMessageDigestResetDuringException() throws IOException, OS3Exception {
    ...
    try (MockedStatic<IOUtils> mocked = mockStatic(IOUtils.class)) {
      ...
      try {
        objectEndpoint.put(DEST_BUCKET_NAME, DEST_KEY, CONTENT.length(), null, null, 1,
            null, null, null, body);
        fail("Should throw IOException");
      } catch (IOException ignored) {
        // Verify that the message digest is reset so that the instance can be reused for the
  ...
  public void testCopyObjectWithTags() throws IOException, OS3Exception {
    ...
    Response copyResponse = objectEndpoint.put(DEST_BUCKET_NAME, destKey, CONTENT.length(), null, null, 1, null, null,
        null, body);
    ...
    copyResponse = objectEndpoint.put(DEST_BUCKET_NAME, destKey, CONTENT.length(), null, null, 1, null, null, null,
        body);
    assertEquals(200, copyResponse.getStatus());
  ...
  public void testCopyObjectWithInvalidTagCopyDirective() throws Exception {
    ...
    try {
      objectEndpoint.put(DEST_BUCKET_NAME, "somekey", CONTENT.length(), null, null, 1, null, null, null, body);
    } catch (OS3Exception ex) {
  ...
  void testDirectoryCreationOverFile() throws IOException, OS3Exception {
    ...
    final ByteArrayInputStream body =
        new ByteArrayInputStream(CONTENT.getBytes(UTF_8));
    objectEndpoint.put(FSO_BUCKET_NAME, path, CONTENT.length(), null, null, 0, "", null, null, body);

    // WHEN
    final OS3Exception exception = assertThrows(OS3Exception.class,
        () -> objectEndpoint
            .put(FSO_BUCKET_NAME, path + "/", 0, null, null, 0, "", null, null, null)
            .close());
  ...
  public void testPutEmptyObject() throws IOException, OS3Exception {
    ...
    Response putResponse = objectEndpoint.put(BUCKET_NAME, KEY_NAME, emptyString.length(), null, null, 1, null, null,
        null, body);
    assertEquals(200, putResponse.getStatus());
    OzoneKeyDetails keyDetails = clientStub.getObjectStore().getS3Bucket(BUCKET_NAME).getKey(KEY_NAME);
