...
public final class S3GatewayConfigKeys {
  ...
  public static final String OZONE_S3G_CONTENT_HTTP_ENABLED_KEY =
      "ozone.s3g.content.http.enabled";
  public static final String OZONE_S3G_CONTENT_HTTP_BIND_HOST_KEY =
      "ozone.s3g.content.http-bind-host";
  public static final String OZONE_S3G_CONTENT_HTTPS_BIND_HOST_KEY =
      "ozone.s3g.content.https-bind-host";
  public static final String OZONE_S3G_CONTENT_HTTP_ADDRESS_KEY =
      "ozone.s3g.content.http-address";
  public static final String OZONE_S3G_CONTENT_HTTPS_ADDRESS_KEY =
      "ozone.s3g.content.https-address";
  ...
  public static final int OZONE_S3G_CONTENT_HTTP_BIND_PORT_DEFAULT = 19878;
  public static final int OZONE_S3G_CONTENT_HTTPS_BIND_PORT_DEFAULT = 19879;
