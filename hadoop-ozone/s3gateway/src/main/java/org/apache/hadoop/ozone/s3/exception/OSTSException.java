...
public class OSTSException extends OS3Exception {
  ...
  public String toXml() {
    try {
      ...
      // Fallback
      final String namespace = "InvalidAction".equals(getCode()) ? AWS_FAULT_NS : STS_NS;

      // STS error responses don't have prolog <?xml version="1.0" encoding="UTF-8"?>
      final StringBuilder builder = new StringBuilder("");
      builder.append("<ErrorResponse xmlns=\"");
      ...
      builder.append("</RequestId></ErrorResponse>");
  ...
  private static class ErrorResponse {
    ...
    ErrorResponse(OSTSException ex) {
      this.xmlns = "InvalidAction".equals(ex.getCode()) ? AWS_FAULT_NS : STS_NS;
