...
public class OzoneClientProducer {
  ...
  public synchronized OzoneClient createClient() throws WebApplicationException,
    ...
    client.getObjectStore().
        getClientProxy().
        setTheadLocalS3Authentication(getSignature(ozoneConfiguration));
    return client;
  }
  ...
  private S3Authentication getSignature(OzoneConfiguration config) {
    try {
      ...
      return new S3Authentication(stringToSign, signatureInfo.getSignature(), awsAccessId);
