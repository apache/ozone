...
/**
 * Result of a {@link ContainerDirectoryScanner} walk over DataNode storage volumes.
 */
public final class ContainerScanResult {
  ...
  ContainerScanResult(Map<Long, String> singles, Map<Long, List<String>> duplicates,
    ...
    this.volumeScanErrors = Objects.requireNonNull(volumeScanErrors, "volumeScanErrors");
  }
