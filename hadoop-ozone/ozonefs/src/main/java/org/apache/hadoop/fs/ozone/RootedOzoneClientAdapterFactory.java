 ...
 */
public final class RootedOzoneClientAdapterFactory {

  static final Logger LOG =
      LoggerFactory.getLogger(RootedOzoneClientAdapterFactory.class);

  private RootedOzoneClientAdapterFactory() {
  }

  @SuppressFBWarnings("DP_CREATE_CLASSLOADER_INSIDE_DO_PRIVILEGED")
  public static RootedOzoneClientAdapter createAdapter()
      throws IOException {
  ...
  public static RootedOzoneClientAdapter createAdapter(
    ...
    ClassLoader currentClassLoader =
        RootedOzoneClientAdapterFactory.class.getClassLoader();
    ...
    try {
      ...
      RootedOzoneClientAdapter ozoneClientAdapter =
  ...
  private static void findEmbeddedLibsUrl(List<URL> urls,
      ClassLoader currentClassloader) throws MalformedURLException {
  ...
  interface OzoneClientAdapterCreator {
    RootedOzoneClientAdapter createOzoneClientAdapter(Class<?> clientAdapter)
